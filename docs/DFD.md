...
This document provides Data Flow Diagrams (DFD), State Diagrams, and Sequence Diagrams that describe how data moves through the TFO-MCP Server system.
...
flowchart TB
    ...
    subgraph TFO_MCP["TFO-MCP Server"]
